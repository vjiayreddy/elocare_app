      ...
      >
        ...
        <DialogContent>
          <Grid container spacing={1}>
            <Grid item xs={12}>
              <FormLabel>Enter the patient’s heart rate (bmp)</FormLabel>
            </Grid>
            <Grid item xs={12}>
              <FormTextInputField
                control={control}
...
export default VitalHeartRateForm;
