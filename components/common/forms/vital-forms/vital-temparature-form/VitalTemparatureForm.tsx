...
interface VitalTemparatureFormProps {
  open: boolean;
  handleOnClose: () => void;
  vitalData: any;
  id: string;
...
const VitalTemparatureForm = ({
  open,
  vitalData,
  id,
  handleOnClose,
}: VitalTemparatureFormProps) => {
      ...
      >
            ...
            <Grid item xs>
              <Box mb={2} sx={{ textAlign: "center" }}>
                <img
                  ...
                  src="/vitals/v2/temparature.svg"
                />
                <Typography variant="h6">Temparature</Typography>
              </Box>
            </Grid>
          </Grid>
        </DialogTitle>
        <DialogContent>
          <Grid container spacing={1}>
            <Grid item xs={12}>
              <FormLabel>Enter the patient’s temperature (°F)</FormLabel>
            </Grid>
            <Grid item xs={12}>
              <FormTextInputField
                control={control}
...
export default VitalTemparatureForm;
