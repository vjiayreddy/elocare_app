...
interface VitalHeartRateFormProps {
  open: boolean;
  handleOnClose: () => void;
  vitalData: any;
  id: string;
...
const VitalRespiratoryRateForm = ({
  open,
  handleOnClose,
  vitalData,
  id,
}: VitalHeartRateFormProps) => {
      ...
      >
        ...
        <DialogContent>
          <Grid container spacing={1}>
            <Grid item xs={12}>
              <FormLabel>
                Enter the patient’s respiratory rate (breathe per min)
              </FormLabel>
            </Grid>
            <Grid item xs={12}>
              <FormTextInputField
...
export default VitalRespiratoryRateForm;
